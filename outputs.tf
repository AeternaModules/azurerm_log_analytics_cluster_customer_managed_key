output "log_analytics_cluster_customer_managed_keys_id" {
  ...
  value       = { for k, v in azurerm_log_analytics_cluster_customer_managed_key.log_analytics_cluster_customer_managed_keys : k => v.id if v.id != null && length(v.id) > 0 }
}
output "log_analytics_cluster_customer_managed_keys_key_vault_key_id" {
  ...
  value       = { for k, v in azurerm_log_analytics_cluster_customer_managed_key.log_analytics_cluster_customer_managed_keys : k => v.key_vault_key_id if v.key_vault_key_id != null && length(v.key_vault_key_id) > 0 }
}
output "log_analytics_cluster_customer_managed_keys_log_analytics_cluster_id" {
  ...
  value       = { for k, v in azurerm_log_analytics_cluster_customer_managed_key.log_analytics_cluster_customer_managed_keys : k => v.log_analytics_cluster_id if v.log_analytics_cluster_id != null && length(v.log_analytics_cluster_id) > 0 }
}
